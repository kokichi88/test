package gameData
{
    ...
    public class BuildingType extends Object
    {
        ...
        public static var GOLD_STORAGE:String = "STO_1";
        public static var ELIXIR_STORAGE:String = "STO_2";
        public static var DARK_ELIXIR_STORAGE:String = "STO_3";
        public static var CANON:String = "DEF_1";
        public static var ACHER_TOWER:String = "DEF_2";
        public static var MOTAR:String = "DEF_3";
        public static var WIZARD_TOWER:String = "DEF_4";
        public static var AIR_DEFENSES:String = "DEF_5";
        public static var XBOW:String = "DEF_6";
        public static var WALL:String = "WAL_1";
        public static var LABORATORY:String = "LAB_1";
        public static var BUILDER_HUT:String = "BDH_1";
        public static var CLAN_CASTLE:String = "CLC_1";
        public static var TRA_1:String = "TRA_1";
        public static var TRA_2:String = "TRA_2";
        ...
        public static var TOW:String = "TOW";
        public static var LAB:String = "LAB";
        public static var CAT:String = "CLC";
        public static var AMC:String = "AMC";
        public static var BAR:String = "BAR";
        public static var WAL:String = "WAL";
        public static var BH:String = "BDH";
