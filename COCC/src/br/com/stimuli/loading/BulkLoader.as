package br.com.stimuli.loading
{
    ...
    public class BulkLoader extends EventDispatcher
    {
        ...
        public function add(param1, param2:Object = null) : LoadingItem
        {
            ...
            _loc_3.addEventListener(Event.COMPLETE, this._incrementItemsLoaded, false, int.MAX_VALUE, true);
        ...
        public function reload(param1) : Boolean
        {
            ...
            _loc_2.addEventListener(Event.COMPLETE, this._incrementItemsLoaded, false, int.MAX_VALUE, true);
        ...
        public function loadNow(param1) : Boolean
        {
            ...
            if (this._getNumConnections() >= this.numConnections || this._getNumConnectionsForItem(_loc_2) >= this.maxConnectionsPerHost)
            {
        ...
        {
            var _loc_1:* = this._getAllConnections();
            _loc_1.sortOn(["priority", "bytesRemaining", "_additionIndex"], [Array.NUMERIC, Array.DESCENDING, Array.NUMERIC, Array.NUMERIC]);
            var _loc_2:* = LoadingItem(_loc_1[0]);
            return _loc_2;
        }// end function
        ...
        public function _getNextItemToLoad() : LoadingItem
        {
            ...
            this._getAllConnections().forEach(function (param1:LoadingItem, ... args) : void
            {
            ...
            var _loc_2:int = 0;
            var _loc_3:* = this._items;
            while (_loc_3 in _loc_2)
            {
                
                checkItem = _loc_3[_loc_2];
        ...
        public function _loadNext(param1:LoadingItem = null) : Boolean
        {
            ...
            if (param1)
            {
                ...
                {
                    _loc_3 = this._getConnectionsForHostName(param1.hostName);
                    _loc_3.push(param1);
                    param1.load();
        ...
        public function _incrementItemsLoaded(event:Event) : void
        {
            var _loc_2:String = this;
            var _loc_3:* = this._itemsLoaded + 1;
            _loc_2._itemsLoaded = _loc_3;
            return;
        }// end function
        ...
        public function _removeFromConnections(param1) : Boolean
        {
            ...
            var _loc_2:* = this._getConnectionsForHostName(param1.hostName);
        ...
        {
            var _loc_2:* = this._getConnectionsForHostName(param1);
            if (!_loc_2)
            {
                return 0;
            }
        ...
        public function _getAllConnections() : Array
        {
            ...
            var _loc_1:Array = [];
            for (_loc_2 in this._connections)
            {
                
                _loc_1 = _loc_1.concat(this._connections[_loc_2]);
            }
            return _loc_1;
        }// end function
        ...
        public function _getNumConnections() : int
        {
            ...
            for (_loc_2 in this._connections)
            {
                ...
                _loc_1 = _loc_1 + this._connections[_loc_2].length;
            }
            return _loc_1;
        }// end function
        ...
        public function get(param1) : LoadingItem
        {
            ...
            for each (_loc_2 in this._items)
            {
                ...
                if (_loc_2._id == param1 || _loc_2._parsedURL.rawString == param1 || _loc_2.url == param1 || param1 is URLRequest && _loc_2.url.url == param1.url)
                {
                    return _loc_2;
                }
            }
        ...
        public function removeAll() : void
        {
            ...
            this._loadedRatio = 0;
            var _loc_2:* = _loc_2;
            this._weightPercent = _loc_2;
            this._percentLoaded = _loc_2;
            return;
        }// end function
        ...
        public function _swallowError(event:Event) : void
        {
            return;
        }// end function
        ...
        public static function registerNewType(param1:String, param2:String, param3:Class = null) : Boolean
        {
            ...
            else if (_customTypesExtensions[param2])
            {
                _customTypesExtensions[param2].push(param1);
            }
            var _loc_5:Object = {};
            {}[TYPE_IMAGE] = IMAGE_EXTENSIONS;
            _loc_5[TYPE_MOVIECLIP] = MOVIECLIP_EXTENSIONS;
            _loc_5[TYPE_VIDEO] = VIDEO_EXTENSIONS;
            _loc_5[TYPE_SOUND] = SOUND_EXTENSIONS;
            _loc_5[TYPE_TEXT] = TEXT_EXTENSIONS;
            _loc_5[TYPE_XML] = XML_EXTENSIONS;
        ...
        public static function guessType(param1:String) : String
        {
            ...
            var _loc_3:* = _loc_2.substring(_loc_2.lastIndexOf("/"));
            var _loc_4:* = _loc_3.substring((_loc_3.lastIndexOf(".") + 1)).toLowerCase();
            if (!Boolean(_loc_4))
            {
                _loc_4 = BulkLoader.TYPE_TEXT;
            }
            if (_loc_4 == BulkLoader.TYPE_IMAGE || BulkLoader.IMAGE_EXTENSIONS.indexOf(_loc_4) > -1)
            {
                _loc_5 = BulkLoader.TYPE_IMAGE;
            }
            else if (_loc_4 == BulkLoader.TYPE_SOUND || BulkLoader.SOUND_EXTENSIONS.indexOf(_loc_4) > -1)
            {
                _loc_5 = BulkLoader.TYPE_SOUND;
            }
            else if (_loc_4 == BulkLoader.TYPE_VIDEO || BulkLoader.VIDEO_EXTENSIONS.indexOf(_loc_4) > -1)
            {
                _loc_5 = BulkLoader.TYPE_VIDEO;
            }
            else if (_loc_4 == BulkLoader.TYPE_XML || BulkLoader.XML_EXTENSIONS.indexOf(_loc_4) > -1)
            {
                _loc_5 = BulkLoader.TYPE_XML;
            }
            else if (_loc_4 == BulkLoader.TYPE_MOVIECLIP || BulkLoader.MOVIECLIP_EXTENSIONS.indexOf(_loc_4) > -1)
            {
                _loc_5 = BulkLoader.TYPE_MOVIECLIP;
            }
            else
            {
                for (_loc_6 in _customTypesExtensions)
                {
                    
                    for each (_loc_7 in _customTypesExtensions[_loc_6])
                    {
        ...
        public static function getFileName(param1:String, param2:Boolean = false) : String
        {
            ...
            var _loc_3:* = param1.lastIndexOf("/") + 1;
            var _loc_4:* = param1.substring(_loc_3);
            var _loc_5:* = param2 ? (_loc_4.length) : (_loc_4.indexOf("."));
            if ((param2 ? (_loc_4.length) : (_loc_4.indexOf("."))) == -1)
            {
                if (_loc_4.indexOf("?") > -1)
                {
            ...
            var _loc_6:* = _loc_4.substring(0, _loc_5);
            return _loc_4.substring(0, _loc_5);
        }// end function
