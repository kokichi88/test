package br.com.stimuli.loading.loadingtypes
{
    ...
    public class LoadingItem extends EventDispatcher
    {
        ...
        public var _bytesRemaining:int = 2.14748e+009;
        ...
        public function onProgressHandler(event:ProgressEvent) : void
        {
            ...
            var _loc_2:* = new BulkProgressEvent(BulkLoader.PROGRESS, true, false);
            _loc_2._percentLoaded = this._percentLoaded;
            _loc_2.bytesTotal = this._bytesTotal;
            _loc_2.bytesLoaded = this._bytesLoaded;
        ...
        {
            var _loc_1:* = this._bytesTotal / 1024;
            if (_loc_1 < 1024)
            {
                return Math.ceil(_loc_1) + " kb";
            }
            return (_loc_1 / 1024).toPrecision(3) + " mb";
        }// end function
