package org.as3commons.reflect
{
    ...
    public class Constant extends Field
    {
        ...
        {
            var _loc_7:* = new Constant(param1, param2, param3, param4, param5, param6);
            return doCacheCheck(_loc_7);
        }// end function

        public static function addToCache(param1:Constant) : void
        {
        ...
        public static function doCacheCheck(param1:Constant) : Constant
        {
            var _loc_3:Boolean = false;
            var _loc_4:Constant = null;
