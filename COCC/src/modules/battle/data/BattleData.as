    ...
    public class BattleData extends Object
    {
        ...
        public function addObj(param1:DataObject) : void
        {
            ...
            if (param1.objId < 0)
            {
                ...
                var _loc_5:* = this.genObjId + 1;
                _loc_4.genObjId = _loc_5;
            }
        ...
        public function getIndexObject(param1:int, param2:Vector.<DataObject>) : int
        {
            if (param2.length <= 0)
            {
                return -1;
            ...
            var _loc_3:int = 0;
            var _loc_5:* = (--param2.length + _loc_3) / 2;
            while (_loc_3 < _loc_4)
            {
                
                if (param1 == param2[_loc_5].objId)
                {
                    return _loc_5;
                }
                if (param1 < param2[_loc_5].objId)
                {
                    --param2.length = _loc_5 - 1;
                }
                else
                {
                    _loc_3 = _loc_5 + 1;
                }
                _loc_5 = (--param2.length + _loc_3) / 2;
            }
            if (param1 == param2[_loc_3].objId)
            {
                return _loc_3;
