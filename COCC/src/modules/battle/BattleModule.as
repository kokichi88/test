package modules.battle
{
    ...
    public class BattleModule extends BaseModule
    {
        ...
        public var clanIconFriend:int = -1;
        ...
        public function findComplete(param1:Vector.<Troop>, param2:Boolean) : void
        {
			...
			var troopConfig:Object = JsonMgr.getInstance().getTroopBase();
			for ( var s:String in troopConfig)
			{
				var t:Troop = new Troop();
				t.level = 2;
				t.num = 100;
				t.type = s;
				listTroop.push(t);
