package modules.battle.logic
{
    ...
    public class Winzar extends DataTroop
    {
        private var bullet:Bullet;

        public function Winzar()
        {
            numFrameAttack = 9 * DataObject.DELAY_FRAME;
        ...
        private function createBullet() : void
        {
            if (curTarget && curTarget.avatar)
            {
                ...
                this.bullet.setType(Bullet.WIZART);
                ...
                this.bullet.radius = 0.3 * BaseInfo.WIDTH_CELL;
        ...
        private function showBullet() : void
        {
            ...
            if (curTarget && curTarget.avatar && this.bullet.arrow)
            {
                ...
                _loc_2 = new Point(curTarget.avatar.x + Utility.randomNumber(-15, 15), curTarget.avatar.y + Utility.randomNumber(-15, 15));
